...
We decompose 
\begin{equation}
q(z,a,c,\mid v,x,e,t) = q(z \mid v,x,e,t)
\end{equation}
...
1) train $p(z,a,c\mid x,e,t)$ to approximate the posterior of a conditional model of text given a complete KB
2a) train $p(v \mid z,a,c,x,e,t)$ to approximate the posterior a full generative model of text and KB
2b) train $p(v \mid z,a,c,x,e,t)$ using the lower bound in Eqn~\ref{eqn:lowerbound}.
