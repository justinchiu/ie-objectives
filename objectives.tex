...
a large number of facts, we focus on identifying facts at a scale that minimizes ambiguity
by casting the identification problem as an unsupervised word level classification task.
