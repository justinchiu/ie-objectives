...
that is aligned to sequences of text that discuss subsets of the information in the KB.
...
In the following section we propose a model for this distribution $p(v \mid x, e, t)$.
