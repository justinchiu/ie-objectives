...
The complete KB $\Delta$ can be viewed as a data table where
...
is not sufficient.
Suppose we had a model that directly filled in $v \mid x$.
It would be difficult to separate the contribution of the text from 
