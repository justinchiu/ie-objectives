...
We define a `word-level' decision or value as pertaining to individual words,
while a `sequence-level' decision or value refers to a single decision or value for a whole sequence.
