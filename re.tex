...
\end{equation}
\item Aggregation:
We parameterize a distribution over the value $v_j$ by counting
votes of relevant word-level values.
...
If no word votes for any values, i.e. there does not exist
